...
public class AdapterPersona extends RecyclerView.Adapter<AdapterPersona.AdapterPersonaHolder> implements View.OnClickListener {
    ...
    public AdapterPersona(Persona[] l){
        super();
        lista=l;
    }
    @NonNull
