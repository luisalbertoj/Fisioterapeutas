...
public class AgregarEditarFichaActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<Persona> call, Response<Persona> response) {
                if (response.isSuccessful()) {
                    ...
                    if (persona != null) {
                        ...
                        Toast.makeText(AgregarEditarFichaActivity.this, "Persona no encontrada", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public void openDataPicker(View view) {
        ...
        dataPiker = new DatePickerDialog(AgregarEditarFichaActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
